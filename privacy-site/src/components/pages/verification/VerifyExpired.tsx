        ...
        <div className="w-full min-h-screen bg-[#0f172a] text-[#f8fafc] font-sans p-8">
            <div className="max-w-md mx-auto space-y-12">
                ...
                <Card className="bg-[#1e293b] border-[#334155]">
                    <CardHeader>
                        <CardTitle className="text-[#f8fafc] text-center text-2xl">Verification expired</CardTitle>
                        <CardDescription className="text-[#cbd5e1] text-center">
                            The verification email has expired. Log in again to get a new verification email.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button
